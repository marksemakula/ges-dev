...
export const routeSeo: Record<string, RouteSeo> = {
  ...
  '/leadership': {
    ...
    description:
      'Meet the leadership and management committee guiding Gombe Education Service (GES) and its network of schools across Uganda, driving excellence since 2013.',
