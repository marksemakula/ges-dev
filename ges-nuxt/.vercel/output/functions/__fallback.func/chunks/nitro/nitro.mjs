...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "1884c9a6-9212-4dc6-ae2d-d6ff0a2fa913",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/institutions/gjs-kikajjo": {
        "redirect": {
          "to": "/institutions/gjs-kampala",
          "statusCode": 301
        }
      },
      "/institutions/gjs-boarding": {
        "redirect": {
          "to": "/institutions/gjs-kampala",
          "statusCode": 301
        }
      },
      "/institutions/gjs-about": {
        "redirect": {
          "to": "/institutions/gjs-gulu",
          "statusCode": 301
        }
      },
      "/institutions/scooby-katale": {
        "redirect": {
          "to": "/institutions/sisu-kampala",
          "statusCode": 301
        }
      },
      "/institutions/scooby-gulu": {
        "redirect": {
          "to": "/institutions/sisu-gulu",
          "statusCode": 301
        }
      },
      "/institutions/iepp": {
      ...
      "/institutions/sakghs-bujuuko": {
        "prerender": true
      },
      "/institutions/sakghs-kawaala": {
        "prerender": true
      },
      "/institutions/gjs-kampala": {
        "prerender": true
      },
      "/institutions/gjs-gulu": {
        "prerender": true
      },
      "/institutions/sisu-kampala": {
        "prerender": true
      },
      "/institutions/sisu-gulu": {
        "prerender": true
      },
      "/admin/**": {
        "robots": false,
...
const _Pl2InCQVUDEKpzhmTHiAYxWreJdjorN4mGOF8PjuE = defineNitroPlugin(async (nitroApp) => {
...
const _6v_cCbXvDVQfdSeZdUUknq4ZoDNkwKuyI6clp4DQQWw = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _Pl2InCQVUDEKpzhmTHiAYxWreJdjorN4mGOF8PjuE,
_6v_cCbXvDVQfdSeZdUUknq4ZoDNkwKuyI6clp4DQQWw
];
...
const _xVTZ_5 = eventHandler(async (e) => {
...
const _BQQ9fQ = defineEventHandler(async (e) => {
...
const _Yxx11J = defineEventHandler(sitemapXmlEventHandler);

const _gKLXD4 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _Egi_el = defineEventHandler(async (e) => {
...
const _lazy_aNbiEp = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_aNbiEp, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _xVTZ_5, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _BQQ9fQ, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Yxx11J, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _gKLXD4, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Egi_el, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_aNbiEp, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withLeadingSlash as A, listener as B, getRouteRules as a, getResponseStatusText as b, createError$1 as c, defineRenderHandler as d, encodePath as e, getResponseStatus as f, getQuery as g, useNitroApp as h, hasProtocol as i, joinRelativeURL as j, defu as k, joinURL as l, parseURL as m, decodePath as n, isScriptProtocol as o, parseQuery as p, withQuery as q, getContext as r, withTrailingSlash as s, withoutTrailingSlash as t, useRuntimeConfig as u, sanitizeStatusCode as v, withBase as w, createHooks as x, executeAsync as y, hasTrailingSlash as z };
