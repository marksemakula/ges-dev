    ...
    function DataExtractor(options, context) {
        ...
        this.getText = function (element) {
            ...
            if (!element.querySelector("[".concat(analytics_core_1.TEXT_MASK_ATTRIBUTE, "], [contenteditable]"))) {
                ...
                clonedTree.querySelectorAll("[".concat(analytics_core_1.TEXT_MASK_ATTRIBUTE, "], [contenteditable]")).forEach(function (node) {
                    node.innerText = analytics_core_1.MASKED_TEXT_VALUE;
                });
