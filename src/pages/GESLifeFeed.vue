...
.filter-btn { padding: 0.4rem 0.875rem; border-radius: 20px; border: 1px solid #E0E0E0; font-size: 0.82rem; font-weight: 500; color: #555555; background: #fff; cursor: pointer; transition: all 0.15s; font-family: inherit; }
...
.feed-card { border: 1px solid #E0E0E0; border-radius: 12px; overflow: hidden; background: #fff; transition: box-shadow 0.2s, transform 0.2s; }
.feed-card:hover { box-shadow: 0 4px 20px rgba(10,35,66,0.1); transform: translateY(-2px); }
.feed-card__img { position: relative; height: 200px; overflow: hidden; background: #F5F5F5; }
.feed-card__img img { width: 100%; height: 100%; object-fit: cover; }
.feed-card__badge { position: absolute; top: 0.75rem; left: 0.75rem; background: #E6B219; color: #1A1A1A; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.07em; text-transform: uppercase; padding: 0.25rem 0.6rem; border-radius: 4px; }
.feed-card__body { padding: 1.25rem; }
.feed-card__date { font-size: 0.75rem; color: #9ca3af; margin-bottom: 0.4rem; }
.feed-card__title { font-size: 0.975rem; font-weight: 700; color: #1A1A1A; margin-bottom: 0.5rem; line-height: 1.35; }
.feed-card__text { font-size: 0.845rem; color: #555555; line-height: 1.6; }
</style>
