<template>
  <div class="admin-page">
    <div class="admin-header">
      <div class="container">
        <h1 class="admin-header__title">GES Admin Panel</h1>
        <p class="admin-header__sub">Content Management System</p>
      </div>
    </div>
    <div class="container admin-body">
      <div class="admin-notice">
        ...
        <div>
          <p class="admin-notice__title">Admin Area</p>
          <p class="admin-notice__text">This area requires authentication. Please contact your GES administrator for access credentials.</p>
        </div>
      </div>
    </div>
  </div>
