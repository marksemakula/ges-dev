...
const posts = ref<Post[]>([
  { id: '1', title: 'The Future of Education: Embracing Digital Learning', excerpt: 'Exploring how digital transformation is reshaping the educational landscape and preparing students for tomorrow\'s challenges.', author: 'Dr. Sarah Mukasa', publishedAt: '2024-01-20', category: 'Innovation', tags: ['digital', 'technology'], image: '/images/Future of Education, Embracing Digital Learning.jpeg', readTime: '5 min read' },
