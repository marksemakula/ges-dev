...
/* ── Institutions ── */
const institutions = [
  { name: 'Jimmy Sekasi Business Institute', type: 'Vocational Institute', logo: '/images/Jimmy Ssekasi Business Institute Logo.png', image: '/images/JIMMY SEKASI.JPG', path: '/institutions/jsbi', url: 'https://jsbi.vercel.app/', description: 'Equipping students with practical business, vocational, and hands-on skills.' },
