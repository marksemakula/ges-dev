...
const GJSBoarding = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden" style={{ viewTransitionName: 'institution-gjs-boarding' }}>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              <h1 className="text-2xl font-bold" style={{ color: brandColors.secondary }}>
                GJS <span style={{ color: brandColors.primary }}>Boarding</span>
              </h1>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-12 max-w-3xl mx-auto">
              Experience world-class international education at GJS - Boarding Campus
            </p>
            <div className="flex flex-wrap justify-center gap-6 mb-12">
              <div className="flex items-center space-x-2">
                <LuMapPin className="w-5 h-5" style={{ color: brandColors.primary }} />
                <span>Gombe, Butambala District</span>
              </div>
              <div className="flex items-center space-x-2">
